...
//
//
//VkSurfaceKHR createSurface(Platform::IWindow* window) {
...
//}
//
//void createSwapChain(VkPhysicalDevice physicalDevice, Platform::IWindow* window) {
...
void VulkanBackend::VulkanGraphicsInfra::AdaptToWindow(Platform::IWindow* window)
{
