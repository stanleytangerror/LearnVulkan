...
void createSurface(VkInstance instance, Platform::IWindow* window, VkSurfaceKHR& surface) {
...
void createLogicalDevice(VkInstance instance, VkSurfaceKHR surface, VkPhysicalDevice physicalDevice, VkDevice& device, 
...
void createSwapChain(VkPhysicalDevice physicalDevice, VkDevice device, Platform::IWindow* window, 
